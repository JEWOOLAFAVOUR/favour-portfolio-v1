...
export default function AboutPage() {
  return (
    <>
      <main className="about-editorial overflow-hidden bg-[#f5f4f0] text-[#383838]">
        <section className="px-6 pb-24 pt-16 sm:px-10 lg:px-[4.7vw] lg:pb-32 lg:pt-24">
            ...
            {journey.map((item) => (
              ...
              >
                <div className="flex w-full flex-col justify-between">
                  <span className="text-[clamp(2.5rem,4vw,4rem)] font-light leading-none tracking-[-0.08em]">
                    {item.number}
                  </span>
                  <div>
        ...
        <section className="px-6 pb-28 pt-8 text-center sm:px-10 lg:pb-40">
          ...
          <a
            href="/contact"
            className="group mx-auto flex max-w-5xl items-center justify-between rounded-full bg-[#f3ddd4] px-8 py-5 text-left transition-transform duration-500 hover:scale-[1.015] sm:px-14 sm:py-7"
          >
            <span className="text-[clamp(1.85rem,4vw,4.25rem)] font-normal leading-none tracking-[-0.06em]">
              GET IN TOUCH
            </span>
            <span className="text-[clamp(2rem,3.8vw,4rem)] font-light leading-none text-[#ff542d] transition-transform duration-500 group-hover:-translate-y-2 group-hover:translate-x-2">
              ↗
            </span>
          </a>
        </section>

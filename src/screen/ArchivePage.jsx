                ...
                <main className="pt-24 lg:py-24">
                    ...
                    <table className="mt-12 w-full border-collapse text-left">
                        <thead className="sticky top-0 z-10 border-b border-slate/30 bg-navy/75 px-6 py-5 backdrop-blur">
                            <tr>
                                <th className="py-4 pr-8 text-sm font-semibold text-slate-lightest">Year</th>
                                <th className="py-4 pr-8 text-sm font-semibold text-slate-lightest">Project</th>
                            ...
                            {allProjects.map((project, index) => (
                                ...
                                >
                                    ...
                                    <td className="hidden py-4 align-top sm:table-cell">
                                        {project.link && project.link !== "#" && project.linkText && (
                                            <a
                                                href={project.link}
                                                target="_blank"
                                                rel="noopener noreferrer"

...
const Navbar = () => {
  ...
  return (
    <header
      className={`fixed w-full z-50 px-6 lg:px-12 transition-all duration-300 ${
        scrolled
          ? "bg-navy/90 backdrop-blur shadow-lg py-4"
          : "bg-transparent py-6"
      }`}
    >
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed inset-0 bg-light-navy/90 z-50 flex flex-col justify-center items-center transition-transform duration-300 ${
